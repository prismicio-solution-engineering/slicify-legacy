...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Descrition field in *Hero → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: Hero.primary.descrition
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
 ...
 * Primary content in *Hero → Primary*
 */
export interface HeroSliceBlueBackgroundPrimary {
  /**
   * TItle field in *Hero → Primary*
   *
   * - **Field Type**: Title
 ...
 * Primary content in *Hero → Items*
 */
export interface HeroSliceBlueBackgroundItem {
  /**
   * Cta label field in *Hero → Items*
   *
   * - **Field Type**: Text
...
/**
 * Blue Background variation for Hero Slice
 *
 * - **API ID**: `blueBackground`
 * - **Description**: Blue Background
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceBlueBackground = prismic.SharedSliceVariation<
  "blueBackground",
  Simplify<HeroSliceBlueBackgroundPrimary>,
  Simplify<HeroSliceBlueBackgroundItem>
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceBlueBackgroundPrimary,
      HeroSliceBlueBackgroundItem,
